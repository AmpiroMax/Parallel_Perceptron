...
Matrix::Matrix(size_t n, size_t m, size_t n_jobs, FillingType type, double fill) : _n_jobs(n_jobs)
{
...
Matrix::Matrix(const std::vector<Row> &v, size_t n_jobs) : _mat(v), _n_jobs(n_jobs)
{
}

Matrix::Matrix(const std::vector<std::vector<double>> &v, size_t n_jobs) : _n_jobs(n_jobs)
{
...
Matrix::Matrix(const Row &row, size_t n_jobs) : _mat(1, row), _n_jobs(n_jobs)
{
}
